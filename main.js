...
const modalContent = {
  Project_2: {
    title: "🧠 Clark AI",
    content:
      "Clark is an AI-powered workspace designed to help users think, create, and execute faster. It combines tools like writing, ideation, and structured thinking into one interface. I led product design, system thinking, and frontend execution—focusing on speed, clarity, and a Notion-like experience with AI at its core.",
    link: "https://clarkai-fe.vercel.app/",
  },

  Project_3: {
    title: "💌 Linnked",
    content:
      "Linnked is a platform for sending meaningful, beautifully designed messages through a simple link. Built for moments like appreciation, love, and connection. I focused on emotional UX, virality loops, and rapid interaction design to make sending messages feel instant and special.",
    link: "https://linnked.vercel.app/",
  },

  Project_1: {
    title: "📈 Bybull",
    content:
      "Bybull is a modern platform focused on finance, markets, and intelligent insights. The goal is to simplify complex financial data into clean, intuitive interfaces. I worked on product direction, UI systems, and creating a strong, credible visual identity.",
    link: "https://bybull.ai/",
  },

  Chest: {
    title: "👋 About Me",
    content:
      "Hey, you found this 👀. I'm Seyi Ogundipe, a Design Engineer, 3D Artist, and Writer. I build products at the intersection of design, technology, and business. My focus is on creating systems that feel simple on the surface but are powerful underneath. This space showcases some of the things I've been building.",
  },

  Picnic: {
    title: "🧠 My Mind",
    content:
      "I like building, thinking, and experimenting. Whether it's startups, design systems, or new ideas, I'm always exploring how things work and how they can be better. This whole experience is basically a reflection of how I think — interactive, a bit unconventional, but intentional.",
  },
};
